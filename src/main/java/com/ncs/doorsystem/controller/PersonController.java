...
public class PersonController 
{
	...
	public List<PersonModal> getAllPerson(@RequestParam("custId") long custID)
	{
		List<PersonModal>  persons =service.getAllPerson(custID);
		return persons;
	}
	
	@RequestMapping(path = "/getallpersonsofsite",method = {RequestMethod.GET,RequestMethod.POST},produces = "application/json")
	public List<PersonModal> getAllPersonsOfSite(@RequestParam("custId") long custID,@RequestParam("siteid") long siteid)
	{
		List<PersonModal>  personsOfSite =service.getAllPersonsOfSite(custID,siteid);
		return personsOfSite;
	}
	
	@PostMapping(value="/create",produces = "application/json")
	public ResponseEntity<Object>  createNewPerson(@Valid @RequestBody PersonModal modal,@RequestParam("custId") long custid,@RequestParam("siteid") long siteid) throws Exception
	{
    ...
    public PersonModal getPerson(@RequestParam("personid") long personid) 
	{
		PersonModal res=service.getPerson(personid);
	...
	@PutMapping("/update")
	public PersonModal updatePesron(@RequestParam("personid") long personid, @RequestBody PersonModal personUpdate) {
	...
	public PersonModal updatePesronWithGroups(@RequestParam("personid") long personid,@RequestParam("custId") long custid,@RequestParam("siteid") long siteid ,@RequestBody PersonModal personUpdate)
	{
