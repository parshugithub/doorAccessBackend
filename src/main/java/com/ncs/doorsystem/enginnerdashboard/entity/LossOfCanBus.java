...
public class LossOfCanBus {
	...
	public LossOfCanBus(int doorid, int activatedondoor, String lockrelay1, String lockrelay2, long siteid) {
		super();
		this.doorid = doorid;
		this.activatedondoor = activatedondoor;
		this.lockrelay1 = lockrelay1;
	...
	public String toString() {
		return "LossOfCanBus [doorid=" + doorid + ", activatedondoor=" + activatedondoor + ", lockrelay1=" + lockrelay1
				+ ", lockrelay2=" + lockrelay2 + ", siteid=" + siteid + "]";
	}
