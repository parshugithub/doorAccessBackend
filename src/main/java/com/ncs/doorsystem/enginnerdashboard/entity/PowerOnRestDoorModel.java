...
@Entity
public class PowerOnRestDoorModel {
	@Id
	...
	public PowerOnRestDoorModel(int doorid, int activatedondoor, String lockrelay1, String lockrelay2, long siteid) {
		super();
		this.doorid = doorid;
		this.activatedondoor = activatedondoor;
		this.lockrelay1 = lockrelay1;
	...
	public PowerOnRestDoorModel() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "PowerOnRestDoorModel [doorid=" + doorid + ", activatedondoor=" + activatedondoor + ", lockrelay1="
